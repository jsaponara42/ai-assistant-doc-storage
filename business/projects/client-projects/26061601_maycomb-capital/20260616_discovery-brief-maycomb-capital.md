...
- **Possible portfolio-company referral pipeline (sourced, June 16, 2026 kickoff call):** Ariella raised this herself, unprompted, tied to Danielle's departure: since the SOPs being built for Maycomb are a natural byproduct of Danielle preparing to leave, and some portfolio companies likely have similar operational pain, she floated the idea of introducing Blue Tusk to portfolio companies that are struggling. Her exact framing left it open, not committed: "we can have more conversations about whether or not it makes sense to be introduced to portfolio companies and how that might work." Two conditions attached: scoped only to companies that are *struggling*, not the full portfolio, and any introduction would need Maycomb's active blessing per company, given how explicitly they care about confidentiality (raised on the same call, re: the MSA). Ariella is now gone; Martina was not in that conversation and has no reason to know it happened. This needs to be reintroduced, not assumed live, and fits most naturally as a byproduct of Track C / VD-2 discovery (borrower asset management) rather than a standalone ask. See [[20260710_Maycomb_Upsell_Pricing_and_Pitch_Prep]].
...
### Andi Phillips — Managing Partner; Playbook enforcement authority (NEW to Playbook role, confirmed July 17, 2026)
- **Status:** Not a new person to this engagement, despite how the July 17 email introduced her. **Andi is almost certainly the same "Andi (Managing Partner)" already established throughout the engagement** as the sole budget-approval authority — named explicitly and repeatedly in `SOPs/Maycomb_Capital_Budgeting_SOP` ("Managing Partner (Andi)" reviews and approves the annual budget and all revisions via Slack; escalation path is "Andi or another Managing Partner" if she's unavailable) and in the workflow map's W4 spine. What's genuinely new as of July 17 is her surname (Phillips) and her second role: one of four people, alongside Barry Porozni, Martina Sebring, and Varenka Giordani, who will hold authority to enforce the finalized AI Playbook.
- **Open reconciliation item, carried from the workflow map:** the workflow map separately flags an unresolved question of whether "Andi" (as named in the SOPs) and "Andy" (as named in the June workflow-deep-dive transcript, for discretionary Fund legal allocations) are the same person. Worth confirming directly rather than assuming, though "Andi Phillips, Managing Partner" is the more likely candidate for both given the budget-approval overlap.
> ⚠️ NEEDS INPUT: Confirm Andi Phillips is the same Andi named throughout the Budgeting SOP and workflow map (very likely, not yet explicitly confirmed), reconcile against the workflow map's separate "Andi vs Andy" question, and get her contact details — she now matters for two distinct reasons: she's the standing budget-approval authority (relevant to any paid engagement requiring her sign-off) and newly named Playbook enforcement authority.
...
16. Confirm Andi Phillips is the Managing Partner already established throughout the Budgeting SOP and workflow map as the budget-approval authority (very likely, not yet explicitly confirmed) — named July 17, 2026 as one of four people with authority to enforce the finalized AI Playbook, and separately worth reconciling against the workflow map's open "Andi vs Andy" question. Contact details still needed.
