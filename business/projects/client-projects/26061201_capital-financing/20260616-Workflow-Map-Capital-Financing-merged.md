...
>
> **Source basis.** [[20260612_discovery-brief-capital-financing]], the first intro call transcript (Howie + John-Carlos), a 2026-06 ops call between Christy and Josh, Christy's process-trunk roster, CEO strategic conversation (2026-06) on sales accountability, KPI implementation, operations oversight, and staffing performance, and Christy's 1:1 discovery call (2026-09-10) covering Intake and Underwriting in detail. Anywhere the source doesn't pin down a step, field, owner, or hand-off, it's marked **`[TO CONFIRM]`** — these double as the next-pass interview checklist (primary conduit: Christy; Kaz for CRM mechanics).
>
