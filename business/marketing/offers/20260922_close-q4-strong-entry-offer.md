...
- **Warm traffic (skips Stage 1 entirely):** different treatment — stays **free**, gated by a separate, lighter qualification step (short form or call) since trust is already established from the existing relationship. Exact qualification mechanism for this path still needs defining (see Next steps).
