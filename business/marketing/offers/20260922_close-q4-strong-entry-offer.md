...
- **Warm traffic (skips Stage 1 entirely):** different treatment — stays **free**, gated by a separate, lighter qualification step (short form or call) since trust is already established from the existing relationship. **Resolved 2026-09-22:** warm traffic is defined simply by source — JC's existing CRM contacts, warm intros from a mutual relationship, or referrals. No separate qualification form/call needed; origin itself is the gate.
