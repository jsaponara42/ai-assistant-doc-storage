...
|---|---|
| `reaction` | React to a specific news article, tool release, or AI/automation update — link the source |
| `hot-take` | Dramatic, contrarian opinion that goes against conventional thinking in the space |
...
- [ ] [[business/marketing/writing/post-ht-linkedin-one-subscription|"LinkedIn tricks you into thinking you need more than one AI subscription"]] — multi-tool posts are creator-to-creator content dressed as advice; pick one and use it well
...
- [x] [[business/marketing/writing/post-story-ai-workflow-stack|"My AI workflow stack: Claude, Obsidian, a local MCP server, and git"]] — specific breakdown of the setup: voice notes or chat → Claude → local MCP writes to markdown files in an Obsidian vault → git keeps it synced; why this over Claude Code; the philosophy of owning your own context layer
...
- [x] [[business/marketing/writing/post-story-what-sops-taught-me|"I didn't understand SOPs until I had to automate without one"]] — what writing and enforcing SOPs at M+P taught JC about process discipline, and why they're load-bearing for any automation that lasts
...
- [x] [[business/marketing/writing/post-instagram-content-strategy|"My modular Instagram content strategy"]] — three-pass filming (hooks, middles, CTAs) + AI stitching tool = hundreds of variations from one session
- [ ] [[business/marketing/writing/post-story-vibe-coding-pitfalls|"What I learned from vibe coding (and what I built wrong without knowing it)"]] — built something that works on the surface but doesn't scale; discovered backend principles the hard way because AI moves fast and you can miss foundational decisions
- [ ] [[business/marketing/writing/post-story-vibe-coding-restart|"Sometimes it's faster to restart than to fix the code you already wrote"]] — when a project changed direction mid-build, rewriting from the right principles beat trying to patch the existing codebase
- [ ] [[business/marketing/writing/post-story-vibe-coding-early-feedback|"Vibe coding lets you get real feedback before you've committed to anything"]] — used to need wireframes and planning to get input; now you can build a working prototype fast enough that stakeholders see something real early, which means better feedback and less rework
- [ ] [[business/marketing/writing/post-story-agent-adoption-via-team|"The AI adoption tactic that actually worked: let the team deliver it"]] — at Maslansky, agent skills delivered by staffers got far more adoption than top-down evangelism; peer-to-peer beats prophet-to-congregation every time
- [ ] [[business/marketing/writing/post-story-scope-creep-vibe-coding|"Vibe coding causes scope creep faster than anything I've ever seen"]] — when people see how quickly you can build, they start asking for everything; the MVP never ships because you keep adding lanes; building fast is only valuable if you stay focused
- [ ] [[business/marketing/writing/post-story-rocky-team-instability|"Our automation project stalled — and it wasn't the automation's fault"]] — team inconsistency broke the process; AI and automation require stable inputs and consistent people; when the team changes, the pieces that make automation work start to break
- [ ] [[business/marketing/writing/post-story-pausing-ambitious-project|"I told a client to pause their automation project. It was the right call."]] — Rocky context: when a client finds a way to be profitable without heavy AI, the right advisor says so; pausing now and returning when the cash flow is proven is better than automating something that hasn't been validated; trust is the long game
- [ ] [[business/marketing/writing/post-story-hallucination-politics|"I got burned by an AI hallucination — and I use AI every single day"]] — lazily asked Claude how many US presidents came from a different party than the previous president (not as VP succession); it said never; that's very wrong; the conversation went sideways and we didn't catch it until later; blind AI confidence may be more dangerous than no confidence at all
- [ ] [[business/marketing/writing/post-story-task-prioritization|"How I prioritize tasks across projects without losing my mind"]] — not tool-specific; organize by task → project → due date; focus on due date so accountability stays consistent regardless of which project it comes from; always moving, always clear on what's next
- [ ] [[business/marketing/writing/post-story-adversarial-analysis|"I built a prompt that attacks my own ideas — and it makes everything better"]] — adversarial analysis skill: feed it an idea, product, piece of marketing; it acts as an adversary and tears apart every assumption; AI defaults to agreement so you have to build in the counterforce
- [ ] [[business/marketing/writing/post-story-getting-into-ai|"People keep asking me how to get into AI. Here's what I actually tell them."]] — "get into AI" is too broad; it's like saying "get into computers" in the '90s; the question is what sector you care about and what companies in that space need non-technical people to do; find the intersection of your background and an AI-forward org, not a career pivot from scratch
...
## Notes
- Stub files above don't need to exist yet — Obsidian allows forward wikilinks
- When drafting a post, create the file at the linked path with full frontmatter
