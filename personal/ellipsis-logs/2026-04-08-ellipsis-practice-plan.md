---
title: "Ellipsis Practice Plan — Tiered Progression"
date: 2026-04-08
...
### Key patterns from attempt history

- **Recurring block:** No autopilot shutoff initiated at the start of interactions — entering conversations without establishing initial control, playing catch-up the whole time
- **Biggest gap:** Needs mapping half-done — pinning people on the map but not feeding the need back in the moment; the loop never closes
- **What's working:** 4-second delay mirror (success Dec '25), embedded commands in plausible real-world context (Jun '25)
- **Deprioritize:** Breath pacing — attempted twice with no traction, too hard to isolate without other mechanics solid
...
One person → one need → one comment = complete attempt.
